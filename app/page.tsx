      ...
      <section className="relative">
        ...
        <div className="container relative z-10 mx-auto px-4 py-24 sm:py-32 md:py-40">
          ...
          >
            ...
            >
              We facilitate successful expansion of businesses into Singapore
              and Southeast Asia with strategic guidance and local expertise.
            </motion.p>
            <motion.div
          ...
          <AnimateInView>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-slate-600 dark:text-slate-400">
                Comprehensive solutions to navigate the complexities of
                international business expansion in Asia
              </p>
            </div>
          </AnimateInView>
                ...
                <Card className="border-0 dark:bg-slate-800 shadow-lg transition-all duration-300 hover:shadow-xl">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-slate-600 dark:text-slate-400">
                      Tailored approaches to enter Southeast Asian markets with
              ...
              >
                <Card className="border-0 dark:bg-slate-800 shadow-lg transition-all duration-300 hover:shadow-xl">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-slate-600 dark:text-slate-400">
                      Accelerate your growth with strategic partnerships and
        ...
        <div className="container mx-auto px-4">
          <AnimateInView>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-slate-600 dark:text-slate-400">
                The principles that guide our approach to business
          ...
          <div className="grid gap-10 md:grid-cols-3">
            <AnimateInView delay={0.1} direction="left">
              <div className="text-center">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Trusted by our clients, partners and regulators, we maintain
            ...
            <AnimateInView delay={0.2} direction="up">
              <div className="text-center">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Finding and achieving shared objectives through collaborative
                  partnerships.
                </p>
              </div>
            </AnimateInView>
          ...
          <AnimateInView>
            ...
            >
              ...
              <p className="mx-auto mb-8 max-w-2xl text-xl text-white/90">
                Let our experts guide you through every step of your
